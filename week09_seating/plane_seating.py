...
# Collaborators: Jerusha Theobald, Ashley Ufret, Théa Williams
# consulted: Joshua Hans , Kate Maschmeyer (Kate also shared her initial template revision to the plane_seating.py)
# moved file to the correct directory 11/19/22 (file was accidentally saved as weekly09_seating/plane_seating.py)
